...
function loadQuestion() {
  ...
  questionElement.innerHTML = `<strong>Question for TK. ${levels[currentQuestion]}</strong><br>${question[0]}`;
...
function checkAnswer(selectedOption) {
  ...
  if (selectedOption === correctOption) {
    ...
    resultElement.textContent = "Correct answer! You earned TK. " + money;
  } else {
  ...
  if (currentQuestion < questions.length) {
    ...
    resultElement.textContent += " You take TK. " + money + " to home.";
  }
}
